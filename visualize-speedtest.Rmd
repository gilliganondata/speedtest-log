...
get_plot_ts <- function(test_data){
...
gg_download_ts <- get_plot_ts(download_data)
gg_upload_ts <- get_plot_ts(upload_data)

gg_download_ts
gg_upload_ts

# gg_download_dist <- ggplot(download_data, aes(bw)) +
#   geom_histogram() +
#   theme_plot
# 
# gg_download_dist
